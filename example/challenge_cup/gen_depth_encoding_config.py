...
def main():
    ...
    config = ImageEncodingConfig(
        ...
        topic_mapping={
            f"{camera_namespace}/left_camera/aligned_depth_to_color/image_raw": "/left_camera/aligned_depth_to_color/image_raw/compressed_data",  # noqa: E501
            f"{camera_namespace}/middle_camera/aligned_depth_to_color/image_raw": "/middle_camera/aligned_depth_to_color/image_raw/compressed_data",  # noqa: E501
            f"{camera_namespace}/right_camera/aligned_depth_to_color/image_raw": "/right_camera/aligned_depth_to_color/image_raw/compressed_data",  # noqa: E501
        },
