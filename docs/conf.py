...
import robo_orchard_recorder_app
...
project = "RoboOrchardDataRecorder"
copyright = "2024-2025, Horizon Robotics Developers"
author = "Horizon Robotics Developers"

# # The short X.Y version
version = robo_orchard_recorder_app.__version__
release = robo_orchard_recorder_app.__version__
...
html_context = {
    "current_version_id": os.getenv(
        "ROBO_ORCHARD_DATA_RECORDER_DOCS_CURRENT_VERSION_ID", "master"
    ),
    "versions_json_url": os.getenv(
        "ROBO_ORCHARD_DATA_RECORDER_DOCS_VERSIONS_JSON",
        "https://horizonrobotics.github.io/robot_lab/robo_orchard/data_recorder/version.json",
    ),
}
...
html_theme_options = {
    ...
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/HorizonRobotics/robo_orchard_data_recorder",
            "html": """
...
htmlhelp_basename = "RoboOrchardDataRecorder"
...
man_pages = [
    (master_doc, "RoboOrchardDataRecorder", "Documentation", [author], 1)
]
